const data = [
  { id: 1, question: 'Barre', answer: 'The ballet barre is where most of class will be held. You will use the barre for resistance and for general balance. Though you should not be leaning heavily on the barre, it does come in handy when you are on your highest heels.' },
  { id: 2, question: 'Tube', answer: 'A resistance tube can be a single or double tube (like the one pictured). A tube be will used from warm up to the cool down stretch.' },
